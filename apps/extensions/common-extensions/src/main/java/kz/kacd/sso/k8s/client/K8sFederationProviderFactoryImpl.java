...
public class K8sFederationProviderFactoryImpl implements K8sClientSpecProviderFactory {
    ...
    public K8sClientSpecProvider create(KeycloakSession session) {
        ...
        return new K8sClientSpecProviderImpl(session, new K8sClientRepository(clientProvider.getClient()));
    }
